                            ...
                            <div class="media-content">
                                ...
                                <div class="columns is-mobile">
                                    <div class="column is-one-half">
                                        <a class="button is-primary is-fullwidth" href="{{route('roles.show', $role->id)}}">Details</a>
                                    </div>
                                    <div class="column is-one-half">
                                        <a class="button is-primary is-fullwidth" href="{{route('roles.edit', $role->id)}}">Edit</a>
                                    </div>
                                </div>
                            </div>
                        </article>
